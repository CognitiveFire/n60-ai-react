    ...
    <nav className="navbar">
      <div className="navbar-container">
        ...
        <nav className="navbar-nav">
          ...
          <a href="#/training" onClick={(e) => { e.preventDefault(); window.location.hash = '/training'; }}>Opplæring & Kurs</a>
      ...
      {menuOpen && (
        <div className="mobile-menu">
          ...
          <nav className="mobile-menu-nav">
            ...
            <a href="#/training" onClick={(e) => { e.preventDefault(); setMenuOpen(false); window.location.hash = '/training'; }}>Opplæring & Kurs</a>
